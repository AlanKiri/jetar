...
- Built a full Docker and Docker Swarm deployment structure integrated with a RESTful API to automate system control. The infrastructure reacts to subscription statuses to deploy, disable, or edit user limits based on selected plans.
- Implemented a complete logging infrastructure with health monitoring and load balancing, supporting horizontal scaling for higher-demand clusters.
</Indent>
...
<Indent>
Migrated legacy Apache/Linux server environments to fully documented Ansible workflows and automated Docker deployments. This eliminated manual server configuration, reduced deployment errors, and established a reproducible infrastructure pipeline.
</Indent>
